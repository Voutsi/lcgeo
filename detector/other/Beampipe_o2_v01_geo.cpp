...
static Ref_t create_element(Detector& theDetector,
  ...
  for(xml_coll_t c( xmlBeampipe ,Unicode("section")); c; ++c) {
	...
	//ConeSegment goldSolid( zHalf, rInnerStart, rOuterStart, rInnerEnd, rOuterEnd, phi1, phi2);
	ConeSegment goldSolid( zHalf, rInnerStart-0.006*dd4hep::mm, rInnerStart-0.001*dd4hep::mm, rInnerEnd-0.006*dd4hep::mm, rInnerEnd-0.001*dd4hep::mm, phi1, phi2);
	...
	if( crossType == ODH::kCenter ) { 
	  ...
	  if (isCylinder) {  // cylinder
	    ...
	    VolCylinder aucylSurf1( goldLog , SurfaceType( SurfaceType::Helper ) , 0.5*0.005*dd4hep::mm  , 0.5*0.005*dd4hep::mm , auocyl );
	    VolCylinder aucylSurf2( goldLog2, SurfaceType( SurfaceType::Helper ) , 0.5*0.005*dd4hep::mm  , 0.5*0.005*dd4hep::mm , auocyl );
...
DECLARE_DETELEMENT(Beampipe_o2_v01,create_element)
